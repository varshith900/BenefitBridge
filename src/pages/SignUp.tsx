...
const { signInWithGoogle } = useAuth();
  ...
  return (
    <div className="min-h-screen flex relative overflow-hidden bg-slate-50 dark:bg-slate-950 font-sans">
      <div className="absolute inset-0 bg-mesh opacity-40 mix-blend-multiply flex-row-reverse pointer-events-none" />
      
      <div className="hidden lg:flex relative w-0 flex-1 bg-slate-950 overflow-hidden items-center justify-center">
         <div className="absolute inset-0 bg-gradient-to-tr from-emerald-900/90 to-slate-950/95" />
         ...
         >
            <div className="grid grid-cols-2 gap-4 mb-10 opacity-90 drop-shadow-xl">
              <div className="w-16 h-16 bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl flex items-center justify-center"><div className="w-8 h-8 rounded-full border-4 border-emerald-400 border-t-transparent animate-spin" /></div>
              <div className="w-16 h-16 bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl flex items-center justify-center"><div className="w-8 h-2 bg-emerald-400 rounded-full animate-pulse" /></div>
              <div className="w-16 h-16 bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl flex items-center justify-center"><Bot className="text-emerald-400 w-8 h-8" /></div>
              <div className="w-16 h-16 bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl flex items-center justify-center"><div className="w-6 h-6 border-2 border-emerald-400 rounded-sm" /></div>
            </div>
            ...
            <p className="text-slate-300 text-lg max-w-md leading-relaxed font-medium">
              Join thousands securing their public benefits with intelligent automation.
            </p>
         </motion.div>
      </div>
      ...
      <div className="flex-1 flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-20 xl:px-24 z-10">
        ...
        >
          ...
          <div className="bg-white dark:bg-slate-900 p-8 sm:p-10 rounded-3xl shadow-xl dark:shadow-2xl border border-slate-100 dark:border-slate-800">
            <h2 className="text-3xl font-extrabold text-slate-900 dark:text-white tracking-tight font-heading mb-2 text-center">Create your account</h2>
            <p className="text-sm text-slate-500 dark:text-slate-400 mb-8 text-center">
              Already have an account? <Link to="/login" className="font-semibold text-emerald-600 hover:text-emerald-500 transition-colors hover:underline underline-offset-4">Sign in</Link>
            </p>
